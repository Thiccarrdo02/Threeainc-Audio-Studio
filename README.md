...
- Separate Voice Lab for instant upload-and-clone, saved-voice speech, public voice browsing/import, design, transform, remix, and local voice management.
...
- Custom voice metadata is stored locally in ignored `.local/custom-voices.json`.
- The custom voice providers are isolated from the main TTS workspace; Fal/Gemini remains the primary TTS provider.
